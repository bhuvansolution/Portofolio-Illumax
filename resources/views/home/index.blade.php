...
@section('container')
    ...
    <div class="simple-slider position-relative">
        ...
        <div class="text-center text-white slider-title position-absolute w-100" style="z-index: 10; top: 30%;">
            <h1 class="fw-bold" style="text-align:left;">{{ $banner->title }}</h1>
            ...
            <div class="wu-bg">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-8 col-xxl-8">
                        <div class="row">
                            @foreach ($whychoose->gambar as $key => $gambar)
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                                    <div class="d-flex mt-4">
                                        <div
                                            ...
                                            </svg><img class="img-fluid icon-"
                                                src="assets/images/whychoose/{{ $gambar }}" width="32"
                                                height="32">
                                        </div>
                                        <div class="px-3">
                                            <h4 class="service-judul">{{ $whychoose->title[$key] }}</h4>
                                            <p class="paragraph-wu">{{ $whychoose->description[$key] }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
