...
@section('container')
        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
            ...
            <div class="intro-y box p-5 mt-6">
                ...
                <div class="mt-1">
                    ...
                    <a href="/dashboard/our-project?status=Publish"
                    ...
                    <a href="/dashboard/our-project?status=Draft"
                        ...
                        <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                            <a class="w-3/5 file__icon file__icon--image mx-auto">
                                <div class="file__icon--image__preview image-fit">
                                    <img alt="{{ $item->title }}" src="/assets/images/our-project/{{ $item->gambar }}">
                                </div>
                            </a>
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        ...
                                        @if ($item->status === 'Draft')
                                            ...
                                            <li>
                                                <a href="{{ route('project.status', ['id' => $item->id, 'status' => 'Publish']) }}"
                                        ...
                                        @elseif($item->status === 'Publish')
                                            ...
                                            <li>
                                                <a href="{{ route('project.status', ['id' => $item->id, 'status' => 'Draft']) }}"
    ...
    @include('dashboard.project.edit')
    <!-- BEGIN: Modal delete -->
    @foreach ($project as $gall)
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <div class="px-5 pb-8 text-center">
                            ...
                            <form action="/dashboard/our-project/{{ $gall->id }}" method="post">
                                @method('DELETE')
                                @csrf
