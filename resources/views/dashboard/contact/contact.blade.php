                        ...
                        <div class="intro-y box p-5 mt-5">
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                <div
                                    ...
                                    <i data-lucide="chevron-down" class="w-4 h-4 mr-2"></i>Information Head Office
                                </div>
                                <div class="mt-5">
                                        ...
                                        <div class="form-label xl:w-64 xl:!mr-10">
                                            <div class="text-left">
                                                ...
                                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                    <div>Masukkan alamat lengkap perusahaan untuk
                                                        memudahkan menemukan lokasi perusahaan.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea name="alamat" id="alamat" rows="5" class="w-full form-control">{{ old('alamat', $contact->alamat) }}</textarea>
                                            @error('alamat')
                                    ...
                                    <div
                                        ...
                                        <div class="form-label xl:w-64 xl:!mr-10">
                                            <div class="text-left">
                                                ...
                                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                    <div>Masukkan nomor WhatsApp yang aktif agar pelanggan dapat
                                                        berkomunikasi secara cepat dan langsung.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                    ...
                                    <div
                                        ...
                                        <div class="form-label xl:w-64 xl:!mr-10">
                                            <div class="text-left">
                                                ...
                                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                    <div>Masukkan alamat email perusahaan untuk menerima pertanyaan atau
                                                        informasi lebih lanjut dari pelanggan.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                    ...
                                    <div
                                        ...
                                        <div class="form-label xl:w-64 xl:!mr-10">
                                            <div class="text-left">
                                                ...
                                                <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                    <div>Masukkan URL Google Maps embed untuk memudahkan pelanggan menemukan
                                                        lokasi Perusahaan. Pastikan link tersebut dapat diakses dan valid.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="web" name="web" type="url" class="form-control"
                                                placeholder="Url Web" value="{{ old('web', $contact->web) }}">
                                            @error('web')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
