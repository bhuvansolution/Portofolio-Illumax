...
@section('container')
    <form action="/dashboard/gallerypage/{{ $gallery->id }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                ...
                                <div class="mt-5">
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea name="textatas" id="textatas" rows="5" class="w-full form-control">{{ old('textatas', $gallery->textatas) }}</textarea>
                                            @error('textatas')
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea name="engtextatas" id="engtextatas" rows="5" class="w-full form-control">{{ old('engtextatas', $gallery->engtextatas) }}</textarea>
                                            @error('engtextatas')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="mt-5">
                                    <div
                                        ...
                                        <div class="w-32 mt-3 xl:mt-0 flex-1">
                                            <textarea name="quote" id="quote" rows="5" class="editor">{{ old('quote', $gallery->quote) }}</textarea>
                                    ...
                                    <div
                                        ...
                                        <div class="w-32 mt-3 xl:mt-0 flex-1">
                                            <textarea name="engquote" id="engquote" rows="5" class="editor">{{ old('engquote', $gallery->engquote) }}</textarea>
                                            @error('engquote')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea name="textbawah" id="textbawah" rows="5" class="w-full form-control">{{ old('textbawah', $gallery->textbawah) }}</textarea>
                                            @error('textbawah')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <textarea name="engtextbawah" id="engtextbawah" rows="5" class="w-full form-control">{{ old('engtextbawah', $gallery->engtextbawah) }}</textarea>
                                            @error('engtextbawah')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
                    ...
                    <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
                            ...
                            <div class="mt-5">
                                <div class="intro-x box px-5 py-3 mb-3 flex items-center zoom-in">
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="gambar-{{ $gallery->id }}" class="form-label">Upload Image</label>
                                        <div class="border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4">
                                            <div class="flex flex-wrap px-4 cursor-pointer"
                                                id="preview-{{ $gallery->id }}">
                                                ...
                                                @if ($gallery->gambar)
                                                    <div
                                                        ...
                                                        <img class="rounded-md" alt="Preview Image"
                                                            src="/assets/images/gallerypage/{{ $gallery->gambar }}">
                                                        <div title="Remove this image?"
                                                            class="tooltip w-5 h-5 flex items-center justify-center absolute rounded-full text-white bg-danger right-0 top-0 -mr-2 -mt-2"
                                                            onclick="remove({{ $gallery->id }}, 'preview')">
                                            ...
                                            <div class="px-4 pb-4 flex items-center relative cursor-pointer">
                                                ...
                                                or drag and drop
                                                <input id="gambar-input-{{ $gallery->id }}" name="gambar"
                                                    type="file" accept="image/*"
                                                    class="w-full h-full top-0 left-0 absolute opacity-0 cursor-pointer"
                                                    onchange="preview(event, {{ $gallery->id }})">
                                                <input type="hidden" name="hapus_gambar"
                                                    id="hapus-gambar-{{ $gallery->id }}" value="0">
                                            </div>
                                        </div>
                                        @error('gambar')
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3 2xl:mt-8">
                            ...
                            <div class="mt-5">
                                <div class="intro-x box px-5 py-3 mb-3 flex items-center zoom-in">
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="gambar1-{{ $gallery->id }}" class="form-label">Upload Image</label>
                                        <div class="border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4">
                                            <div class="flex flex-wrap px-4 cursor-pointer"
                                                id="preview1-{{ $gallery->id }}">
                                                <!-- Pratinjau Gambar Akan Ditambahkan di Sini Secara Dinamis -->
                                                @if ($gallery->gambar1)
                                                    <div
                                                        class="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
                                                        <img class="rounded-md" alt="Preview Image"
                                                            src="/assets/images/gallerypage/{{ $gallery->gambar1 }}">
                                                        <div title="Remove this image?"
                                                            class="tooltip w-5 h-5 flex items-center justify-center absolute rounded-full text-white bg-danger right-0 top-0 -mr-2 -mt-2"
                                                            onclick="remove({{ $gallery->id }}, 'preview1')">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="w-4 h-4 cursor-pointer" viewBox="0 0 24 24"
                                                                fill="none" stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            <div class="px-4 pb-4 flex items-center relative cursor-pointer">
                                                ...
                                                <span class="text-primary mr-1 cursor-pointer">Upload a file</span>
                                                or drag and drop
                                                <input id="gambar1-input-{{ $gallery->id }}" name="gambar1"
                                                    type="file" accept="image/*"
                                                    class="w-full h-full top-0 left-0 absolute opacity-0 cursor-pointer"
                                                    onchange="preview(event, {{ $gallery->id }})">
                                                <input type="hidden" name="hapus_gambar1"
                                                    id="hapus-gambar1-{{ $gallery->id }}" value="0">
                                            </div>
                                        </div>
                                        @error('gambar1')
                                            <div class="text-danger mt-2">
