                                ...
                                <div class="mt-5">
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="title" name="title" type="text" class="form-control"
                                                value="{{ old('title', $artikel->title) }}" placeholder="Title">
                                            @error('title')
                                    ...
                                    <div
                                        ...
                                        <div class="w-32 mt-3 xl:mt-0 flex-1">
                                            <textarea name="description" id="description" rows="5" class="editor">{{ old('description', $artikel->description) }}</textarea>
                                            @error('description')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                @if ($artikel->gambar)
                                                    <div
                                                        ...
                                                        <img class="rounded-md" alt="Preview Image"
                                                            src="/assets/images/artikel/{{ $artikel->gambar }}">
    ...
    <script>
        ...
        title.addEventListener('input', function() {
            ...
            if (title.value.trim() === '') {
                ...
                timeout = setTimeout(() => {
                    fetch('/dashboard/artikel/checkslug?title=' + encodeURIComponent(title
                            .value))
