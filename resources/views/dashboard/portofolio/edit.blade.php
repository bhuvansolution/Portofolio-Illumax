...
@section('container')
    <form action="/dashboard/our-portofolio/{{ $portofolio->id }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                ...
                                <div class="mt-5">
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="slug" name="slug" type="text" class="form-control"
                                                value="{{ old('slug', $portofolio->slug) }}" readonly>
                                            <div class="form-help text-right">Maximum character 0/70</div>
                                            @error('slug')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <select id="status" name="status" class="form-select">
                                                <option value="Publish"
                                                    {{ old('status', $portofolio->status) == 'Publish' ? 'selected' : '' }}>
                                                    Publish
                                                </option>
                                                <option value="Draft"
                                                    {{ old('status', $portofolio->status) == 'Draft' ? 'selected' : '' }}>
                                                    Draft
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="w-32 mt-3 xl:mt-0 flex-1">
                                            <textarea name="description" id="description" rows="5" class="editor">{{ old('description', $portofolio->description) }}</textarea>
                                            @error('description')
                                                <div class="text-danger form-help text-left">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                @if ($portofolio->gambar)
                                                    <div
                                                        ...
                                                        <img class="rounded-md" alt="Preview Image"
                                                            src="/assets/images/portofolio/{{ $portofolio->gambar }}">
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <div class="border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4">
                                            <div class="flex flex-wrap px-4 cursor-pointer" id="preview-container1">
                                                ...
                                                @if ($portofolio->video)
                                                    <div
                                                        class="file w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
