        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
            ...
            <div class="intro-y box p-5 mt-6">
                ...
                <div class="mt-1">
                    ...
                    <a href="/dashboard/our-partner?status=Publish"
                    ...
                    <a href="/dashboard/our-partner?status=Draft"
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        ...
                                        @if ($item->status === 'Draft')
                                            ...
                                            <li>
                                                <a href="{{ route('partner.status', ['id' => $item->id, 'status' => 'Publish']) }}"
                                        ...
                                        @elseif($item->status === 'Publish')
                                            ...
                                            <li>
                                                <a href="{{ route('partner.status', ['id' => $item->id, 'status' => 'Draft']) }}"
